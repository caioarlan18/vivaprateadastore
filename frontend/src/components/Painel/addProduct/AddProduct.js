    ...
    return (
        <div className={styles.add}>
            ...
            <div className={styles.add1}>
                {imageSrc && (
                    <div>
                        ...
                        <button onClick={handleRemoveImage} style={{ backgroundColor: "red" }}>Remover</button>
                    </div>
                )}
                <input
                    type="file"
            ...
            <div className={styles.add1}>
                ...
                <input placeholder='Ex: Corrente1' type="text" value={title} onChange={handleTitle} />
            </div>
            <div className={styles.add1}>
            ...
            <div className={styles.add1}>
                ...
                <input placeholder='Ex: Descrição completa do produto' type="text" value={description} onChange={handleDescription} />
            </div>
            <div className={styles.add1}>
